...
2026-09-16: 12言語の概要にdepartment（組織・部署）を追加し、会社名との区別を明記。日本語を「共有する項目」「共有設定」に統一した新しい設定画面を掲載。審査メモに新規項目の既定オフ、再選択による取り込み、独立した共有設定を追加。全言語の保存内容・文字数・iPhone 4枚／Watch 3枚を確認し、1.0.0 (4)を再提出。[詳細](app-review-build-4-2026-09-16.md)。
